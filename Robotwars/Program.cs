...
namespace RobotWars
{
    class Program
    {
        ...
        {
            // Sample scenarios from the document
            Scenario(0, 2, 'E', "MLMRMMMRMMRR"); // Scenario 1
            Scenario(4, 4, 'S', "LMLLMMLMMMRMM"); // Scenario 2
            Scenario(2, 2, 'W', "MLMLMLMRMRMRMRM"); // Scenario 3
            Scenario(1, 3, 'N', "MMLMMLMMMMM"); // Scenario 4
        }
